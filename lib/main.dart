...
import 'package:test_router/screens/author_details.dart';
import 'package:test_router/screens/authors.dart';
import 'package:test_router/screens/book_details.dart';
import 'package:test_router/screens/books.dart';
import 'package:test_router/screens/scaffold.dart';
import 'package:test_router/screens/settings_screen.dart';
import 'package:collection/collection.dart';
import 'package:test_router/screens/sign_in.dart';
...
class Bookstore extends StatelessWidget {
  ...
  late final GoRouter _router = GoRouter(
    routes: <GoRoute>[
      ...
      GoRoute(
        path: '/book/:bookId',
        redirect: (GoRouterState state) => '/books/all/${state.params['bookId']}',
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        redirect: (GoRouterState state) => '/authors/${state.params['authorId']}',
      ),
      GoRoute(
        path: '/authors',
        pageBuilder: (BuildContext context, GoRouterState state) => FadeTransitionPage(
